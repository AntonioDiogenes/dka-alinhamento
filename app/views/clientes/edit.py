"""
Tela 3: Edição de Cliente (views/clientes/edit.py).
Renderiza ClientForm (readOnly=False) e o Histórico de Atendimentos do Cliente integrado na mesma página.
"""
...
class ClientEditView(tk.Frame):
    ...
    def _build_ui(self):
        ...
        lbl_title = tk.Label(
            self.header,
            text=f"Editar Cliente — {self.client_data.get('nome', '')}",
        ...
        # Container Rolável para Formulário + Histórico
    ...
    def _on_save(self, data: Dict[str, Any]):
        ...
        messagebox.showinfo("Sucesso", f"Dados do cliente '{saved['nome']}' atualizados com sucesso!")
